...
// $start = new DateTime($hari_ini);
// $finish = new DateTime($akhir);
// $intss = $finish->diff($start);
  ...
  while ($data = mysqli_fetch_array($sql)) {
   ...
   ?>
                                                                      ...
                                                                      <div class="card">
                                                                           <div class="card-body pt-3">
                                                                                ...
                                                                                <div class="tab-content pt-2">
                                                                                     <div class="tab-pane fade show active profile-overview"
                                                                                          ...
                                                                                          <form method="POST">
                                                                                               ...
                                                                                               <div class="mb-3 row">
                                                                                                    <label
                                                                                                         class="col-sm-3 col-form-label"><b>No
                                                                                                              Telepon</b></label>
                                                                                                    <div
                                                                                                         class="col-sm-9">
                                                                                                         <input
                                                                                               ...
                                                                                               <div class="mb-3 row">
                                                                                                    <label
                                                                                                         class="col-sm-3 col-form-label"><b>Tanggal
                                                                                                              Lahir</b></label>
                                                                                                    <div
                                                                                                         class="col-sm-9">
                                                                                                         <input
                                                                                               ...
                                                                                               <div class="mb-3 row">
                                                                                                    <label
                                                                                                         class="col-sm-3 col-form-label"><b>Kategori
                                                                                                              User</b></label>
                                                                                                    <div
                                                                                                         class="col-sm-9">
                                                                                                         <select
                                                                                               ...
                                                                                               <div class="mb-3 row">
                                                                                                    <label
                                                                                                         class="col-sm-3 col-form-label"><b>Level
                                                                                                              Akses</b></label>
                                                                                                    <div
                                                                                                         class="col-sm-9">
                                                                                                         <select
                                                                                ...
                                                                                <div class="tab-pane fade pt-3"
                                                                                     ...
                                                                                     <form method="POST">
                                                                                          ...
                                                                                          <div class="mb-3 row">
                                                                                               <label
                                                                                                    class="col-sm-3 col-form-label"><b>RT
                                                                                                         /
                                                                                                         RW</b></label>
                                                                                               <div class="col-sm-4">
                                                                                                    <select
                                                                           ...
                                                                           <div class="tab-pane fade pt-3"
                                                                                ...
                                                                                <form method="POST">
                                                                                     ...
                                                                                     <div class="mb-3 row">
                                                                                          <label
                                                                                               class="col-sm-3 col-form-label"><b>Password
                                                                                                    Lama</b></label>
                                                                                          <div class="col-sm-9">
                                                                                               <input type="text"
                                                                                                    class="form-control"
          ...
          if($data['status'] == 'aktif'){ ?>
                                                            <span
                                                                 class="badge bg-primary fs-5"><?= $data['status']; ?></span>
                                                            <?php } else {
           if ($data['status'] == 'tidak aktif') { ?>
                                                            <span
                                                                 class="badge bg-warning fs-5"><?= $data['status']; ?></span>
                                                            <?php }}?>
