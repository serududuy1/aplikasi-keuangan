            ...
            <div class="card-header">
                <h3>Form Data Saldo Awal
                    <p>
                        <?php
                              //Tanggal kemarin
                              $tgl_kemarin    =date('Y-m-d', strtotime("-1 month", strtotime(date("Y-m-d"))));
                              ?></p>
                </h3>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <br>
                    <form method="POST">
                        <button type="submit" name="add_saldo_awal" class="btn btn-secondary">
                            <span class="icon text-white">
                                <i class="bi bi-plus-lg"></i> Tambah Saldo Awal
                            </span>
                        </button>
                    </form>
  ...
  while ($data = mysqli_fetch_array($sql)) {
   ...
   ?>
                            <tr>
                                ...
                                <!-- edit Modal -->
                                <div class="modal fade" id="MyEdit<?= $data['id']; ?>" data-bs-backdrop="static"
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body pt-3">
                                                            <ul class="nav nav-tabs nav-tabs-bordered">
                                                                ...
                                                                <li class="nav-item"> <button class="nav-link active"
                                                                        data-bs-toggle="tab"
                                                                        data-bs-target="#Biodata"><b>Biodata</b></button>
                                                                </li>

                                                                <li class="nav-item"> <button class="nav-link"
                                                                        data-bs-toggle="tab"
                                                                        data-bs-target="#alamat"><b>Alamat</b></button>
                                                                </li>

                                                                <li class="nav-item"> <button class="nav-link"
                                                                        data-bs-toggle="tab"
                                                                        data-bs-target="#password"><b>Password</b></button>
                                                                </li>
                                                            ...
                                                            <div class="tab-content pt-2">
                                                                <div class="tab-pane fade show active profile-overview"
                                                                    ...
                                                                    <form method="POST">
                                                                        ...
                                                                        <div class="mb-3 row">
                                                                            <label
                                                                                class="col-sm-3 col-form-label"><b>Nama</b></label>
                                                                            <div class="col-sm-9">
                                                                        ...
                                                                        <div class="mb-3 row">
                                                                            ...
                                                                            <div class="col-sm-9">
                                                                                <input type="text" name="tgl_lahir"
                                                                                    class="form-control tgllahir2"
                                                                                    value="<?= $data['tgl_lahir']; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="mb-3 row">
                                                                            <label class="col-sm-3 col-form-label"><b>Kategori
                                                                                    User</b></label>
                                                                            <div class="col-sm-9">
                                                                        ...
                                                                        <div class="mb-3 row">
                                                                            <label class="col-sm-3 col-form-label"><b>Level
                                                                                    Akses</b></label>
                                                                            <div class="col-sm-9">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button type="submit" name="edit_biodata"
                                                                ...
                                                                <form method="POST">
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            ...
                                                                            <div class="mt-2" id="feedback_alamat">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="reset"
                                                                            class="btn btn-danger">Reset</button>
                                                                        <button type="submit" name="edit_alamat"
                                                                            class="btn btn-primary">Simpan</button>
                                                                </form>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="tab-pane fade pt-3" id="password">
                                                            ...
                                                            <form method="POST">
                                                                ...
                                                                <div class="mb-3 row">
                                                                    <label class="col-sm-3 col-form-label"><b>Password
                                                                            Lama</b></label>
                                                                    <div class="col-sm-9">
    ...
    <!-- Modal validasi -->
    <div class="modal fade" id="MyValidasi<?= $data['id']; ?>" data-bs-backdrop="static" data-bs-keyboard="false"
                        ...
                        <div class="row gx-9">
                            <div class="col-md-6">
                                <div class="p-3">
                                    ...
                                    <div class="mb-2 row">
                                        <label class="col-sm-5 col-form-label"><b>Tanggal Lahir
                                            </b></label>
                                        <div class="col-sm-7">
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" value="<?= $data['usertype']; ?>"
                                                readonly>
                                        </div>
                                    </div>
                                ...
                                <div class="p-3">
                                    ...
                                    <form method="POST">
                                        ...
                                        <select class="form-select form-select-sm" name="status" required>
                                            <option value="" selected>-- Pilih Validasi Anggota --
                                            </option>
