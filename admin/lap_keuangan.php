			...
			<div id="data" class="card mt-4">
				...
				<div class="col-md-12 mt-3">
					<form method="POST" class="form-inline">
						<div class="row">
							<div class="col-md-2">
								<input id="datepicker" type="text" name="tgl_mulai" class="form-control mb-2" placeholder="DD/MM/YYYY">
							</div>
							<div class="col-md-2">
								<input id="datepicker2" type="text" name="tgl_selesai" class="form-control ml-3 mb-2" placeholder="DD/MM/YYYY">
							</div>             
							<div class="col-md-4">
...
$sql=mysqli_query($koneksi,"select * from keuangan where status='terima' and rt='$rt' and rw='$rw' and tgl between '$mulai' and '$selesai' "); 
				...
				<div class="row">
					<div class="col-lg-6">
						<a href="lap_keuangan_pdf2.php?tgl_mulai=<?php echo $_POST['tgl_mulai']; ?>&&tgl_selesai=<?php echo $_POST['tgl_selesai']; ?>&&rt=<?php echo $_POST['rt']; ?>&&rw=<?php echo $_POST['rw']; ?>" target="_blank" class="btn btn-primary">    
