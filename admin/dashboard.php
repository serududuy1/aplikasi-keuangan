      ...
      <div class="row">
        <div class="col-md-6">
          <div style="background-color:#e4e3e8;" class="card info-card customers-card">
            <div class="card-body">
              <h5 class="card-title">Total Anggota Aktif <span>| Sistem Karang Taruna</span></h5>
              <div class="d-flex align-items-center">
                <?php  
                require '../config/config.php';
                ...
                while ($data = mysqli_fetch_array($sql)) 
                {
                  ...
                  <div class="ps-3">              
                    ...
                    <span class="text-danger small pt-1 fw-bold">Total Anggota</span> <span class="text-muted small pt-2 ps-1">yang sudah di validasi</span>
                  </div>
                <?php } ?>          
              </div>
              <div class="mt-1 text-end">
                <a href="?url=data_anggota" class="text-dark" >Lihat Detail <i class="bi bi-chevron-double-right"></i></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div style="background-color:#e4e3e8;" class="card info-card customers-card">
            <div class="card-body">
              <h5 class="card-title">Total Anggota Tidak Aktif <span>| Sistem Karang Taruna</span></h5>
              <?php  
              require '../config/config.php';
              $sql = mysqli_query($koneksi,"select count(status) 
              ...
              while ($data = mysqli_fetch_array($sql)) 
              {
                ...
                <div class="d-flex align-items-center">                 
                  ...
                  <div class="ps-3">              
                    <h6><?= $data['count(status)']; ?></h6>                
                    <span class="text-danger small pt-1 fw-bold">Total Anggota</span> <span class="text-muted small pt-2 ps-1">yang belum di validasi</span>
                  </div>         
                </div>                 
              <?php } ?>
              <div class="mt-1 text-end">
  ...
  <section class="section">
    <div class="row">
     <div class="col-md-12">
      <div class="card">
       <div class="card-body">
        <h5 class="card-title">Grafik Line Chart total sumbangan Anggota/Masyarakat Yang Terkumpul</h5>
         ...
         new ApexCharts(document.querySelector("#lineChart"), {
           ...
           grid: {
             row: {
                        ...
                        xaxis: {
                          categories: ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Augustus','September','Oktober','November','Desembar'],
                        }
                      }).render();
});
</script> 
