...
<li class="nav-item">
   <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#"><i class="bi bi-stack"></i><span>Laporan</span><i class="bi bi-chevron-down ms-auto"></i> </a>
