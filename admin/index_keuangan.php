...
<body>
    ...
    <div class="col-md-12">
        <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#addUang">
...
<!-- add uang Modal -->
<div class="modal fade" id="addUang" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel"><b style="font-size: 25px;">Form Add KeUangan</b></h1>
  ...
  <select class="form-select" name="rw" required>
   ...
   <option value="10">10</option>                      
    ...
    <div class="mb-2 mt-3 row">
      ...
      <div class="col-sm-8">
        <textarea type="text" id="textarea_ket" maxlength="50" name="ket" class="form-control" placeholder="Input keterangan" required></textarea>
						...
						while ($data = mysqli_fetch_array($sql)) {
							...
							<tr>
								...
								<td class="text-center">
									...
									<?php
									if($data['status'] == 'kirim'){ ?>										
										<button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#MyV<?= $data['id']; ?>">
											<span class="icon text-white">
												<i class="bi bi-check-circle-fill"></i>
											</span> 
										</button>

									<a href="del2.php?id=<?php echo $data['id']; ?>" class="btn btn-danger btn-icon-split" onclick="return confirm('Yakin Hapus Data ?')">
										<span class="icon text-white">
									...
									<?php } elseif ($data['status'] == 'terima') { ?>
										<button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#MyView<?= $data['id']; ?>">
											<span class="icon text-white">
							...
							<!-- Modal validasi view -->
							<div class="modal fade" id="MyV<?= $data['id']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
								<div class="modal-dialog modal-dialog-scrollable modal-lg">
									<div class="modal-content">
										<div class="modal-header">
											<h1 class="modal-title fs-5" id="staticBackdropLabel"><b>Form Detail Data KeUangan</b></h1>
										...
										<div class="modal-body">
												...
												<div class="row gx-9">
													...
													<div class="col-md-6">
														<div class="p-3">
															...
															<div class="mb-2 row">
																<label class="col-sm-2 col-form-label"><b>RT </b></label>
																<div class="col-sm-10">
																	<input type="text" class="form-control" value="<?= $data['rt']; ?>" readonly>
																</div>
															</div>
															<div class="mb-2 row">
																<label class="col-sm-2 col-form-label"><b>RW </b></label>
																<div class="col-sm-10">
											...
											<div class="container px-4">
												<div class="row gx-5">
													<div class="col-md-6 bg-info">
														<div class="p-3"><b>KeUangan "<?= $data['typeuang']; ?>" Rp.<?= number_format($data['saldo_akhir']) ?> </b></div>
													</div>
													<div class="col-md-6 bg-secondary">
														<div class="p-3">
															...
															<form method="POST">
																...
																<input type="hidden" name="saldo_akhir" class="form-control" value="<?= $data['saldo_akhir']; ?>">     
											...
											<div class="modal-footer">
												<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
												<button type="reset" class="btn btn-danger">Reset</button>
												<button type="submit" name="validasi_keuangan" class="btn btn-primary">Simpan</button>
											</div>
										</form>
									</div>
								</div>
