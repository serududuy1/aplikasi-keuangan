                ...
                <div class="card-body pt-3">
                    <ul class="nav nav-tabs nav-tabs-bordered">
                        <li class="nav-item"> <button class="nav-link active" data-bs-toggle="tab"
                                data-bs-target="#Biodata"><b>Biodata</b></button></li>

                        <li class="nav-item"> <button class="nav-link" data-bs-toggle="tab"
                                data-bs-target="#alamat"><b>Alamat</b></button></li>

                        <li class="nav-item"> <button class="nav-link" data-bs-toggle="tab"
                                data-bs-target="#password"><b>Password</b></button></li>
                    </ul>
   ...
   ?>
                            ...
                            <form method="POST">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="no_telp" onkeypress="return hanyaAngka(event)"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="tgl_lahir" class="form-control tgllahir2"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-select" name="usertype">
                                            <option value="<?= $data['usertype']; ?>" selected><?= $data['usertype']; ?>
                                            </option>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-select" name="level">
                                            <option value="<?= $data['level']; ?>" selected><?= $data['level']; ?>
                                            </option>
                    ...
                    <div class="tab-pane fade pt-3" id="alamat">
                        ...
                        <form method="POST">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text" name="alamat" id="textarea_alamat" maxlength="65"
                                        class="form-control" rows="4" placeholder="Input Alamat Lengkap"
